ALTER TABLE public.bowler_stats_cache ADD COLUMN IF NOT EXISTS clutch_frames integer NOT NULL DEFAULT 0;
ALTER TABLE public.team_stats_cache ADD COLUMN IF NOT EXISTS clutch_frames integer NOT NULL DEFAULT 0;
...
BEGIN
  ...
  FOREACH s IN ARRAY scopes LOOP
    ...
    WITH tm AS (
      ...
      -- skip team games where any rolled bowler game lacks segment data
